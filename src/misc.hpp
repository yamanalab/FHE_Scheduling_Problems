...
inline _colored_stream operator<<(std::ostream &os, ioscc::TColorCode ccode)
{
    ...
    {
        case ioscc::red:
            os << ioscc::_sesc << ioscc::_sred;
            break;
        case ioscc::blue:
            os << ioscc::_sesc << ioscc::_sblue;
            break;
        case ioscc::green:
            os << ioscc::_sesc << ioscc::_sgreen;
            break;
    }
...
template <>
inline _colored_stream operator<<(_colored_stream os,
                                  const ioscc::TColorCode &ccode)
{
